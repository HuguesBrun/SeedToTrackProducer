...
process.muonAssociatorByHitsL2seeds.tracksTag = cms.InputTag("L2seedToTrack")
...
process.p = cms.Path(process.L2seedToTrack*process.muonAssociatorByHitsL2seeds*process.muonAssociatorByHits+process.useMatching)
